...
class VideoDataset(Dataset):
    def __init__(self, folder_path, num_frames=8, transform=None):
        ...
        for identity in os.listdir(folder_path):
            ...
            for video in os.listdir(identity_folder):
                self.video_paths.append(os.path.join(identity_folder, video))
    ...
    def __getitem__(self, idx):
        ...
        return frames, label  # Ensure frames and label are returned
